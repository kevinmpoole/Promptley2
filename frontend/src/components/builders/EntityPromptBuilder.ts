...
============================== */
export const buildEntityPrompt = (attributes: Record<string, any>) => {
  const {
    name,
    title,
    species,
...
============================== */
export const buildWorldPrompt = (attributes: Record<string, any>) => {
  const {
    name,
    climate,
    terrain,
...
============================== */
export const buildScenePrompt = (attributes: Record<string, any>) => {
  const {
    name,
    location,
    time_of_day,
...
/* ==============================
   Prop Prompt Builder
============================== */
export const buildPropPrompt = (attributes: Record<string, any>) => {
  const {
    name,
    material,
    size,
...
/* ==============================
   Shot Prompt Builder
============================== */
export const buildShotPrompt = (attributes: Record<string, any>) => {
  const {
    name,
    camera_angle,
    focus_subject,
...
============================== */
export const buildEventPrompt = (attributes: Record<string, any>) => {
  const {
    name,
    event_type,
    participants,
...
============================== */
export const buildFramePrompt = (attributes: Record<string, any>) => {
  const {
    name,
    perspective,
    mood,
